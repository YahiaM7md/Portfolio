...
const PERSONAL_INFO = {
  ...
  initials: "Welcome To Yahia's Portfolio",
...
const PROJECTS = [
  ...
  ────────────────────────────────────────────────────────────── */
  {
    id: "brand-luxe-coffee",
    category: "graphic",
    title: "Poster Design For K&L brand identity",
    shortDescription: "K&L تصميم بوستر لهوية العلامة التجارية ",
    fullDescription: "A complete brand identity project for Luxe Coffee Co., a specialty coffee chain targeting young urban professionals. The brand needed to feel premium, minimal, and sophisticated while remaining approachable. The visual system spans packaging, in-store signage, takeaway cups, and a full brand guidelines document.",
    ...
    gallery: ["assets/graphic/project1/1.jpg", "assets/graphic/project1/2.jpg", "assets/graphic/project1/3.jpg", "assets/graphic/project1/4.jpg"],
...

  {
    ...
    category: "graphic",
    title: "Project-2",
    shortDescription: "Futuristic brand identity for an AI startup",
    fullDescription: "Nexus AI needed a visual identity that communicated intelligence, innovation, and trustworthiness. The brand was built on a system of geometric shapes symbolizing connected nodes — a metaphor for neural networks and human collaboration. The final package included a logo suite, icon library, brand deck, and complete UI design language.",
    tools: ["Adobe Illustrator", "Figma", "After Effects"],
    cover: "",
    gallery: ["", "", ""],
    brandOverview: "The Nexus brand speaks to both technical teams and enterprise clients. The visual system uses a deep navy and electric blue palette with a modular geometric logomark that works across all sizes.",
    colors: ["#050D1C", "#0066FF", "#00D4FF", "#FFFFFF"],
...

  {
    ...
    category: "graphic",
    title: "Project-3",
    shortDescription: "Packaging design for a healthy food product line",
...

  {
    ...
    cover: "",
    gallery: ["", "", ""],
    brandOverview: "High energy, bold typography, and dynamic composition. The campaign uses a black-and-orange palette with aggressive diagonal layouts to communicate intensity and motivation.",
